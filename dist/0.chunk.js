...
var dashboard_component_1 = __webpack_require__(1341);
var dashboard_routing_1 = __webpack_require__(1366);
var popularApp_1 = __webpack_require__(1374);
var pieChart_1 = __webpack_require__(1371);
var trafficChart_1 = __webpack_require__(1378);
var usersMap_1 = __webpack_require__(1381);
var lineChart_1 = __webpack_require__(1369);
var feed_1 = __webpack_require__(1368);
var todo_1 = __webpack_require__(1376);
var calendar_1 = __webpack_require__(1365);
var calendar_service_1 = __webpack_require__(1340);
var feed_service_1 = __webpack_require__(1342);
var lineChart_service_1 = __webpack_require__(1343);
var pieChart_service_1 = __webpack_require__(1344);
var todo_service_1 = __webpack_require__(1345);
var trafficChart_service_1 = __webpack_require__(1346);
var usersMap_service_1 = __webpack_require__(1347);
...
var Dashboard = (function () {
    ...
    Dashboard.prototype.clicked = function () {
        this.router.navigate(['/pages/newproject/gamedetails']);
        //brand-form
    };
    Dashboard.prototype.clickmaplytiks = function () {
...
var PieChartService = (function () {
    function PieChartService(_baConfig, _httpService) {
        this._baConfig = _baConfig;
        this._httpService = _httpService;
        this.totalimpact = 0;
    }
    PieChartService.prototype.ngOnInit = function () {
        var self = this;
        var post_data = {};
        post_data = {
            channel: "twitter",
    ...
    PieChartService.prototype.ProcessTwitt_Data = function (data2, self) {
        self.totalimpact = data2.impact_score;
        self.totalreach = data2.reach;
    };
    PieChartService.prototype.transformationtotaltweets = function (result, self) {
        self.totalimpact = result;
    };
    PieChartService.prototype.transformationtotalreach = function (result, self) {
    ...
    PieChartService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [(typeof (_a = typeof theme_1.BaThemeConfigProvider !== 'undefined' && theme_1.BaThemeConfigProvider) === 'function' && _a) || Object, (typeof (_b = typeof httpservice_1.HttpServices !== 'undefined' && httpservice_1.HttpServices) === 'function' && _b) || Object])
    ], PieChartService);
...
var Calendar = (function () {
    ...
    Calendar = __decorate([
        core_1.Component({
            selector: 'calendar',
            encapsulation: core_1.ViewEncapsulation.None,
            styles: [__webpack_require__(1408)],
...
__export(__webpack_require__(1364));
...
__export(__webpack_require__(1367));
...
__export(__webpack_require__(1370));
...
__export(__webpack_require__(1372));
...
"use strict";
"use strict";//  require('easy-pie-chart/dist/jquery.easypiechart.js');
...
__export(__webpack_require__(1375));
...
__export(__webpack_require__(1377));
...
__export(__webpack_require__(1379));
...
/* WEBPACK VAR INJECTION */(function(jQuery) {"use strict";
var core_1 = __webpack_require__(0);
var trafficChart_loader_ts_1 = __webpack_require__(1380);
var trafficChart_service_1 = __webpack_require__(1346);
...
"use strict";
"use strict";
exports.Chart = __webpack_require__(1395);
...
__export(__webpack_require__(1382));
...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		amd = helpers.amd = ("function" === 'function' && __webpack_require__(1447)),
		//-- Math methods
...
module.exports = "<div class=\"row\">\n <div class= \"col-xlg-12 col-xl-12 col-lg-12 col-sm-12 col-xs-12 \">\n       <ba-card  title=\" The key objectives of the analysis \" baCardClass=\"medium-card\">\n      \n  <br><h5>\n• Apply Visual Analytics on the Video footage and measure the Sponsor logos exposure and\nmine related statistics</h5><br>\n<h5>\n• Sponsor logos are to be analysed across the different assets on the Stadium (Static and Dynamics Logos) </h5><br>\n<h5>\n• Key exposure statistics such as total time, size of logo, position on screen etc. are collected\nand analyzed </h5><br>\n\n<h5> • Final Media Exposure Index value will be allocted to all the logos detected</h5>\n                <button (click)=\"clicked()\" class=\"btn btn-danger nextbutton1\tfa fa-plus-square \" > Create New Project</button>\n              <button   (click)=\"clickmaplytiks()\" class=\"btn btn-primary  nextbutton \tfa fa-database \" > View Previous Projects</button>\n      </ba-card>\n</div>\n\n    <!--<div class=\"row col-xlg-6 col-xl-6 col-lg-12 col-sm-12 col-xs-12\">\n\n      <ba-card class=\"col-xlg-6 col-xl-12 col-lg-12 col-md-5 col-sm-12 col-xs-12\"\n               baCardClass=\"popular-app medium-card\">\n        <popular-app></popular-app>\n      </ba-card>-->\n    \n\n\n</div>\n\n<div class=\"row\">\n   <ba-card title=\"Notifications\" class=\"col-xlg-12 col-xl-12 col-lg-12 col-md-5 col-sm-12 col-xs-12\"\n            baCardClass=\"medium-card with-scroll feed-panel \">\n     <feed></feed>\n   </ba-card>\n</div>"
